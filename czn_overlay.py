...
CHARS = {
    "Nine":     {"sets":["Line of Justice","Beast's Yearning","Conqueror's Aspect",
                 ...
                 "weights":NINE_W,
                 "good_main":{"desire":"Order DMG%","imagination":["Crit Rate%","Crit DMG%"],"ideal":["Crit Rate%","Crit DMG%"]},
    ...
    "Sereniel": {"sets":["Executioner's Tool","Blackwing","Instinctual Growth",
                 ...
                 "weights":CRIT_DPS,
                 "good_main":{"desire":"Instinct DMG%","imagination":["Crit Rate%","Crit DMG%"],"ideal":["Crit Rate%","Crit DMG%"]},
    ...
    "Rin":      {"sets":["Conqueror's Aspect","Orb of Inhibition","Executioner's Tool","Blackwing",
                 ...
                 "weights":CRIT_DPS,
                 "good_main":{"desire":"Void DMG%","imagination":["Crit Rate%","Crit DMG%"],"ideal":["Crit Rate%","Crit DMG%"]},
                 "goal":"Void / 1-AP DPS"},
    ...
    "Tiphera":  {"sets":["Line of Justice","Tetra's Authority","Executioner's Tool","Healer's Journey"],
                 "weights":TIPHERA_W,
                 "good_main":{"desire":"Order DMG%","imagination":["DEF%","Crit Rate%"],"ideal":["Crit Rate%","DEF%"]},
    ...
    "Khalipe":  {"sets":["Instinctual Growth","Tetra's Authority","Executioner's Tool"],
                 "weights":KHALIPE_W,
                 "good_main":{"desire":"Instinct DMG%","imagination":["DEF%","Crit Rate%"],"ideal":["Crit Rate%","DEF%"]},
                 "goal":"300 DEF + Crit · Potential 7"},
    "Orlea":    {"sets":["Glory's Reign","Tetra's Authority","Healer's Journey","Instinctual Growth"],
                 "weights":DEF_SUP_W,
                 "good_main":{"desire":"HP%","imagination":["DEF%","HP%"],"ideal":["HP%","DEF%"]},
    ...
    "Amir":     {"sets":["Conqueror's Aspect","Tetra's Authority","Executioner's Tool",
                 ...
                 "weights":{"Crit Rate%":0.75,"Crit DMG%":0.75,"DEF":1.0,"DEF%":0.8,
                             ...
                             "DoT%":0.0,"Extra DMG%":0.0},
                 "good_main":{"desire":"Void DMG%","imagination":["DEF%","Crit Rate%"],"ideal":["Crit Rate%","DEF%"]},
    ...
    "Haru":     {"sets":["Line of Justice","Conqueror's Aspect","Executioner's Tool","Blackwing"],
                 "weights":CRIT_DPS,
                 "good_main":{"desire":"Justice DMG%","imagination":["Crit Rate%","Crit DMG%"],"ideal":["Crit Rate%","Crit DMG%"]},
    ...
    "Mei Lin":  {"sets":["Spark of Passion","Executioner's Tool","Blackwing","Conqueror's Aspect"],
                 "weights":CRIT_DPS,
                 "good_main":{"desire":"Passion DMG%","imagination":["Crit Rate%","Crit DMG%"],"ideal":["Crit Rate%","Crit DMG%"]},
...
def score_for_char(char_name, subs, main_name, slot):
    ...
    if slot and main_name:
        ...
        if fixed:
            ...
            if good_main:
                # good_main can be a string or a list of acceptable main stats
                good_list = good_main if isinstance(good_main, list) else [good_main]
                main_ok = main_name in good_list
